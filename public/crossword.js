  ...
  /********************************************************/
            ...
            function clearTable(my_table,row_count){
              ...
              for( var i = 0; i<row_count; i++ ){
                ...
                my_table.deleteRow(0); // deletes only top row i.e row 0
...
function GetWordsFromInput(json_object) {
    ...
    for(var i = 0; i < json_word_list.length; i++){
        ...
        total_points += parseFloat(json_word_list[i].orig_qascore) //.toFixed(1);
    }
    document.getElementById("points").value = total_points
    console.log("Total points",total_points)
    console.log("updated total points in browser",document.getElementById("points").value)
  }
